...
By excluding the solvent w.r.t. scaling the interaction energies  independence from the solvent interaction in the acceptance criteria makes it such that we have good acceptance between the replicas.  
